                ...
                <ul class="navbar-nav me-5">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle 
                            ...
                            Личный кабинет
                            <!-- вместо надписи при авторизации можно вписать имя -->
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../pages/authorization.php">Войти</a></li>
                            <li><a class="dropdown-item" href="../pages/registration.php">Зарегистрироваться</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="../pages/lk.php">Личный кабинет</a></li>
                            <li><a class="dropdown-item" href="../pages/lk.php">Выйти</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
